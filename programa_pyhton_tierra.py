...
button_selector_frame.grid(row=3, column=0, padx=5, pady=5, sticky="nsew")
button_selector_frame.rowconfigure(0, weight=1)
button_selector_frame.columnconfigure(0, weight=1)
tk.Button(button_selector_frame, text="Ver Temperatura", bg="lightgreen", command=mostrar_grafico_temp).grid(sticky="ew", padx=5, pady=3)
